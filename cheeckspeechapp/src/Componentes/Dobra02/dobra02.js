  ...
  return (
    <div className="container-principal-dobra02">
      ...
      <div className="card-clientes">
        ...
        <img className="clienteNet" src={Cliente1} /> 
        <img className="clientes" src={Cliente2} /> 

        </div>
        <div className="card-coluna2">
        <img className="clientesTerra" src={Cliente3} /> 
        <img className="clientesMinty" src={Cliente4} /> 
